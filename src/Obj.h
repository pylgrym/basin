...
public:
  ...
  Obj() :type(OB_None), effect(SP_NoSpell), eqslot(EQ_Unwearable), weight(0),itemUnits(0),ac(1) { clear(); }

  Obj(ObjEnum type_) :type(type_), effect(SP_NoSpell), eqslot(EQ_Unwearable), weight(0), itemUnits(0),ac(1) {
