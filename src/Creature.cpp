...
MobDef mobDefs[] = {
  ...
  { 3, CR_FireAnt, "a", ". fire ant", { "spits", "hisses", "fire", "bites" }, { "beast" } },
  ...
  { 8, CR_Lich, "lich", ". lich", { "undead", "grabs", "holds", "paralyzes", "confuses", "charms", "sleeps", "blinds", "strangles" },{"undead"}},
  { 9, CR_Wraith, "wraith", ". wraith", {"wails","haunts","fears","scares","frightens","dooms"},{"undead"}},
  { 10, CR_Imp, "imp", ". imp", {"cackle", "leers","snickers","claws","scratches"},{"demon"}},
  ...
  { 22,CR_BlueCentipede, "bluecentipede", ". blue centipede", {"gnaws","scurries","scuttles","bites"},  {"insect","lightning"}},
  ...
  { 29,CR_RottingDevourer, "rottingdevourer", ". rotting devourer" , {"defiles","corrupts","rots","bites"},  {"undead"}},
  ...
  { 36,CR_RedDragon, "reddragon", ". red dragon" , {"burns","flames","roasts","bites"},  {"dragon","fire","claw","breath"}},
  ...
  { 39,CR_GreenDragon, "greendragon", ". green dragon", {"stings","hurls","venoms","poisons","bites"},  {"dragon","gas","claw","breath"}},
